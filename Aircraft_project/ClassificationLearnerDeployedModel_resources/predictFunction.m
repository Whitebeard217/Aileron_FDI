...
%
%  Input:
%      varargin: Input argument must be a table, whose 5 columns have the same variable names and data types as the variables that trained the deployed model.
%  Output:
%      result: Prediction results returned by the trained, deployed model

% Auto-generated by MATLAB on 12-May-2025 15:10:05

inputData = varargin{1};

predictorNames = {'R', 'dR', 'ddR', 'x0_5F', 'x0_8F'};
